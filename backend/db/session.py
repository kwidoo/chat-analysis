...
class DatabaseSessionManager:
    ...
    def init_app(self, app: Flask):
        ...
        if db_type == 'mysql':
            ...
            pool_recycle = app.config.get('DB_POOL_RECYCLE', 3600)  # Recycle connections after 1 hour
            ...
            self.engine = create_engine(self.connection_url, connect_args={"check_same_thread": False})
